...
import {RUN_CTB_NEW_API_URL} from "../common/constants";
import { useEffect, useState } from "react";

export default function DisplayNewCTBComponent (props) {
    ...
    const getCTB = (productId) => {
        ...
        axios.post(`${RUN_CTB_NEW_API_URL}`, {
    ...
    return(
        <div>
            <h1>New CTB: {location.state.product_uid}</h1>
            {
